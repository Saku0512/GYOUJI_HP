...
- [ ] 6. ルーティングとサーバー設定のセットアップ
  - [ ] 6.1 Ginルーターとミドルウェアの設定
...
- [ ] 7. トーナメント初期化とシーディングの実装
  - [ ] 7.1 トーナメントシーディングロジックの作成
